// https://donatso.github.io/family-chart/ v0.8.0 Copyright 2025 donatso
...
function setupSiblings({ main, tree, data_stash, node_separation, sortChildrenFunction }) {
    if (!main) {
...
var handlers = /*#__PURE__*/Object.freeze({
    ...
    calculateEnterAndExitPositions: calculateEnterAndExitPositions,
    ...
    handlePrivateCards: handlePrivateCards,
    ...
    setupSiblings: setupSiblings,
    setupZoom: setupZoom,
    sortAddNewChildren: sortAddNewChildren,
    sortChildrenWithSpouses: sortChildrenWithSpouses,
    submitFormData: submitFormData,
    syncRelReference: syncRelReference,
    toggleAllRels: toggleAllRels,
    toggleRels: toggleRels,
    treeFit: treeFit,
    zoomTo: zoomTo
});
    ...
    `);
        ...
        if (location.origin.includes('localhost')) {
            ...
            if (d.data.to_add) {
                ...
                if (spouse)
                    d3.select(this).select('.card').attr('data-to-add', spouse.data.data['first name']);
            }
        }
    };
...
export { CalculateTree, Card, CardHtml, CardHtml$1 as CardHtmlClass, CardSvg, CardSvg$1 as CardSvgClass, calculateTree, CardHtmlWrapper as cardHtml, CardSvgWrapper as cardSvg, createChart, createStore, createSvg, exports as default, elements, handlers, htmlHandlersWithDeprecated as htmlHandlers, icons, view };
